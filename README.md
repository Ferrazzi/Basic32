...
<div align="center">[**Basic32 Web Tools**](https://ferrazzi.github.io/Basic32/index.html)</div>
...
For the complete list of commands, check the **manual PDF** inside the `manual` folder or open [**Basic32 Web Tools**](https://ferrazzi.github.io/Basic32/manual.html) to consult the full programming guide.
